...
Revision ID: 387a8703d84b
Revises:
Create Date: 2025-02-21 21:00:17.868877
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'FROZEN', 'EXPIRED', name='subscriptionstatus'), nullable=False),
    ...
    op.create_table('workoutresults',
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
